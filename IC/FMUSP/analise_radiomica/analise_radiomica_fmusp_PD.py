...
## Análise Radiômica - Pacientes PD 
...
RESULTS_DIR = os.path.join(BASE_DIR, "PD_results")
os.makedirs(RESULTS_DIR, exist_ok=True)
recortes_path = os.path.join(BASE_DIR, "PD_limpo")
...
output_csv = os.path.join(RESULTS_DIR, "radiomics_PD.csv")
if len(features) == 0:
...
output_arff = os.path.join(RESULTS_DIR, "radiomics_PD.arff")
if len(features) == 0:
