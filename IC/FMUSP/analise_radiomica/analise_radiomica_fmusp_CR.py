...
## Ultima alteração: 07/04/2026
## Análise Radiômica - Pacientes CR 
...
RESULTS_DIR = os.path.join(BASE_DIR, "CR_results")
os.makedirs(RESULTS_DIR, exist_ok=True)
recortes_path = os.path.join(BASE_DIR, "CR_limpo")
...
output_csv = os.path.join(RESULTS_DIR, "radiomics_CR.csv")
if len(features) == 0:
...
output_arff = os.path.join(RESULTS_DIR, "radiomics_CR.arff")
if len(features) == 0:
